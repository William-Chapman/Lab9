...
namespace Lab9
{
    class CarApp
    {
        ...
        public static void WriteInfo(List<Car> cars, int userNum)
        {
            Console.WriteLine(cars[userNum - 1].Make);
            Console.WriteLine(cars[userNum - 1].Model);
            Console.WriteLine(cars[userNum - 1].Year);
            Console.WriteLine($"${cars[userNum - 1].Price}");
        }
